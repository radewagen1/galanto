...
export default function Main() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbw9q4tkn172iaqtDWHEHSMmiyz55RzOHM35jAvNiAFlAyDgMF2r40MkLYB_gpeaPIX5YQ/exec";
  ...
  return (
    <>
      <main className="bg-gray-100 min-w-[1230px] hidden md:flex">
        ...
        <div className="">
          <img
            src="https://s1.adform.net/Banners/56957908/56957908.gif?bv=4"
